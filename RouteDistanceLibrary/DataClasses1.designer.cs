...
namespace RouteDistanceLibrary
{
    ...
    partial void Deleteintersection(intersection instance);
		...
		public DataClasses1DataContext() : 
				base(global::RouteDistanceLibrary.Properties.Settings.Default.na2880gConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Ondelay_to_nextChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="line_line_information", Storage="_line", ThisKey="line_id", OtherKey="line_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public line line
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="station_line_information", Storage="_station", ThisKey="station_id", OtherKey="station_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void Online2_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="line_intersection", Storage="_line", ThisKey="line1_id", OtherKey="line_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public line line
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="station_intersection", Storage="_station", ThisKey="station_id", OtherKey="station_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public station station
		{
			get
			{
